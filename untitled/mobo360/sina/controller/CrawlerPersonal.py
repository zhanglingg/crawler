...
def get_personal_base_info(driver,user):
   try:
       ...
       i = 0
       nickname, premise, gender, birthday, intro, registerTime = '', '', '', '', '', ''
...
def personal_info_main(driver, user):
...
if __name__ == '__main__':
    ...
    time.sleep(3)
    list = sina_user.UserInfo.objects.filter(crTime__istartswith='2016-11-25',referFlag='')
    for user in list:
        personal_info_main(driver, user)
